      ...
      <div class="row">
        <div class="col-md-10 col-lg-8 mx-auto text-center">
          ...
          <form action="insert_user_data.php" method="post">
            ...
            <input  class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" name="telefon" id="telefon" placeholder="Enter telefon..."><br>
			<textarea class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" rows="4" cols="50" name="comment" form="usrform">Enter text here...</textarea><br>
